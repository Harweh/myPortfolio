...
export const metadata: Metadata = {
  title: "Emmy Portfolio - Full Stack Developer",
  description: "Portfolio showcasing my projects and skills as a MERN stack developer",
  keywords: ["Full Stack Developer", "MERN", "MENN", "React", "Next.js", "TypeScript", "TailwindCss", "Portfolio"],
  openGraph: {
    title: "Emmy Portfolio - Full Stack Developer",
    description: "Portfolio showcasing my projects and skills as a MERN stack developer",
    type: "website",
